  ...
  return (
    <div>
      ...
      <div id='about' className="mt-4">
        <img id='headshot' src={headshot} alt='Professional headshot of the developer, Michael Loeffler, wearing a white patterned dress-shirt, a dark-red knit tie, and gray glasses.' />
